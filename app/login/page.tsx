        ...
        <div className="backdrop-blur-xl bg-black/40 border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full py-3 bg-gradient-to-b from-cyan-400 to-purple-500 text-white font-semibold rounded-xl hover:from-cyan-300 hover:to-purple-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-cyan-500/25"
            >
              {isSubmitting ? '登录中...' : '登录'}
            </button>
          </form>
